    ...
    @if(isset($researches) && $researches->count() > 0)
        @foreach($researches as $research)
            <tr>
                ...
                <td>
                <button class="btn btn-primary btn-sm edit-btn" data-bs-toggle="modal"   data-bs-target="#edit_research_info_modal"   data-id="{{ $research->id }}" onclick="edit_resech_info({{ $research->id }})"> <i class="fa fa-edit"></i></button>
