    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-12"> <!-- Column Size Boro Kora Holo -->
            <label class="form-label"><b>Description</b></label>
            <textarea name="extra_info" id="extra_info" class="form-control"></textarea>
          </div>
...
<script>
  let extraInfoEditor;
  ClassicEditor
    .create(document.querySelector('#extra_info'))
    .then(editor => {
      extraInfoEditor = editor;
    })
  ...
  function add_new_research() {
    ...
    var extra_info = extraInfoEditor.getData();
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        extraInfoEditor.setData(''); // ✅ Clear CKEditor content after submission
